...
export const Popover = (props: PopoverProps) => {
	return (
		<AriaPopover
			...
			className={(state) =>
				cx(
					"max-h-64! w-(--trigger-width) overflow-y-auto overflow-x-hidden rounded-lg bg-primary py-1 shadow-lg outline-hidden ring ring-secondary_alt will-change-transform",
